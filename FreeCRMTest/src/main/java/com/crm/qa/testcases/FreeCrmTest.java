...
public class FreeCrmTest {
	...
	public void setUp() throws Exception {
		System.setProperty("webdriver.chrome.driver", "C:\\QA\\SeleniumJars/chromedriver");
	...
	public void freeCrmTitleTest() throws InterruptedException, IOException {
		...
		if (title.equals("Free CRM Software for customer relationship management, sales and support")) {
...
//		js.executeScript("$.growl.warning({ title: 'Warning!', message: 'your warning message goes here' });");
	...
	public static void takeScreenshot(String fileName) throws IOException{
		...
		FileUtils.copyFile(src, 
				new File("C:\\QA\\Selenium_Workspace" + fileName +".png"));
